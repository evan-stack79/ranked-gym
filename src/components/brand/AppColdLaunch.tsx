...
const MORPH_AT_RATIO = 300 / COLD_LAUNCH_TOTAL_MS
const BACK_TO_CALM_AT_RATIO = 380 / COLD_LAUNCH_TOTAL_MS
const CENTER_WORDMARK_FADE_AT_RATIO = 300 / COLD_LAUNCH_TOTAL_MS
const REVEAL_AT_RATIO = 525 / COLD_LAUNCH_TOTAL_MS
const HANDOFF_AT_RATIO = 1060 / COLD_LAUNCH_TOTAL_MS
const FLIP_START_AT_RATIO = 300 / COLD_LAUNCH_TOTAL_MS
